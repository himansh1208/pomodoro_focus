        ...
        <div className="row">
          <div className="col">
            ...
            <p className="mb-5 pb-2">
              The <strong style={{color}}>Pomodoro Technique</strong> was created by Francesco Cirillo
            ...
            <ul className="list-unstyled pl-2 mb-0" style={{color}}>
              <li className="pl-2 pb-2 pt-2">
                <strong style={{color}}>Responsive design</strong> that works with desktop and mobile
              </li>
              <li className="pl-2 pb-2 pt-2">
                <strong style={{color}}>Color transition</strong> to switch moods between work time and rest time
              </li>
              <li className="pl-2 pb-2 pt-2">
                <strong style={{color}}>Audio notification</strong> at the end of a timer period
              </li>
              <li className="pl-2 pb-2 pt-2">
                <strong style={{color}}>Customizable timer</strong> intervals to suit your preference
              </li>
              <li className="pl-2 pb-2 pt-2">
                <strong style={{color}}>Charts</strong> with stats and progress
              </li>
            </ul>
          </div>
        </div>
