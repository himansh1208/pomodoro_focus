     ...
     <header className="header_sec" style={{backgroundColor:color}} id="navbar_top">
      <div className="container">
        ...
        <nav className="navbar navbar-expand-md p-0">
          ...
          >
            <span className="navbar-toggler-icon"><strong>x</strong></span>
          </button>
          <div
          ...
          >
            <ul className="navbar-nav d-sm-none">
              ...
              <li className="nav-item active"><Link to="#" className="nav-link">Statistics <span>PRO</span></Link></li>
              <li className="nav-item">
            ...
            <ul className="navbar-nav d-none d-sm-flex">
              <li className="nav-item active">
                <Link className="nav-link" to="#">Statistics <span>PRO</span></Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link" to="#">Settings</Link>
              </li>
